...
data = {}
completedList = ['2017-10-28', '2017-11-01', '2017-10-26', '2017-10-30', '2017-10-31', '2017-10-29', '2017-10-27', '2017-11-02', '2017-11-03', '2017-11-04', '2017-11-05', '2017-11-06']
def read(filename):
...
def create_excel(data):
	...
	for date in data:
		print date
		rates = tablib.Dataset(headers=headers, title=date.strip())
